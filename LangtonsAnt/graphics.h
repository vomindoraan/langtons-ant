...
#define MENU_TILE_H_PADDING 3
#define MENU_TILE_V_PADDING 2
#define MENU_TILE_PWIDTH    (MENU_TILE_SIZE + MENU_TILE_H_PADDING)
#define MENU_TILE_PHEIGHT   (MENU_TILE_SIZE + MENU_TILE_V_PADDING)
...
#define MENU_TILES_HEIGHT   (MENU_TILES_PER_COL*MENU_TILE_PHEIGHT + MENU_TILE_V_PADDING + 3)
///@}
